...
echo ""
echo "grep -E 'a b.* c' words.txt           * = 0 or more (of the previous character)"
echo ""
read
grep -E 'a b.* c' words.txt
read
...
echo ""
echo "grep -E 'a b.? c' words.txt           ? = 0 or 1 (of the previous character)"
echo ""
read
grep -E 'a b.? c' words.txt
read
...
echo ""
echo "grep -E 'a b.+ c' words.txt           + = 1 or more (of the previous character)"
echo ""
read
grep -E 'a b.+ c' words.txt
read
...
echo ""
echo "grep -E 'a b.{3} c' words.txt         {3} exactly 3 (of the previous character)"
echo ""
read
...
echo ""
echo "grep -E 'a b.{2,3} c' words.txt       {2,3} between 2 and 3 (of the previous character)"
echo ""
read
...
echo ""
echo "grep -E 'a \b\w+\b c' words.txt       \b\w+\b will match a single word"
echo ""
read
grep -E 'a \b\w+\b c' words.txt
read
clear
...
echo ""
echo "grep -E '(Eve ){3}' words.txt         The string 'Eve ' 3 times in a row"
echo ""
read
grep -E '(Eve ){3}' words.txt
read
clear
